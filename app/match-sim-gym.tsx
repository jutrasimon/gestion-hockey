...
const fromPlayer = (p: typeof seed[number]): Skater => ({ name: p.name, num:p.num, stats: [...p.stats], style: p.playStyle === 'Direct' ? 0 : p.playStyle === 'Prudent' ? 2 : 1, energy: 100, morale: 100, confidence: 0, weight: p.weight, height: Number(p.height.split(' ')[0]) * 12 + Number(p.height.split(' ').at(-1)) });
